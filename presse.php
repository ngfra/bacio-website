...
<body>
  ...
  <header>
    <div class="container header-container">
      ...
      <p class="font-header">Tauche ein in die Welt von BACIO und entdecke unsere spannende Reise durch die Medien. Erfahre mehr über unsere Leidenschaft, Tradition und Authentizität, die uns zu einer der beliebtesten Pizzamarken macht.</p>
  ...
  <main>
    ...
    <section class="mt-50">
      <div class="container video-container ">
      <img width="50px" src="imgs/illustrations-svg/mircofon.png" alt="radiospot"><h2 class="titel-h3-v2">Radiospot juni 2024  bacio - amore puro</h2>
      </div>

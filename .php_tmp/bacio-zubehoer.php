    ...
    <section class="mt-50">
      <div class="container accesories-container">
        <div class="row d-flex align-items-center ">
          <div class="col-md-5 d-flex justify-content-center">
            <img class="w-100" src="imgs/bacio-kochschürze.png" alt="bacio-kochschürze"
          ...
          <div class="col-md-7">
            ...
            <div class="wrap d-flex "><a class="btn-secondary" href="">jaaaa! ich hole mir!</a></div>
          </div>
        </div>
      </div>
      ...
      <div class="container accesories-container ">
        <div class="row d-flex align-items-center reverse-order-mobile">
          ...
          <div class="col-md-5 d-flex justify-content-center">
            <img class="w-100" src="imgs/bacio-holzteller.png" alt="bacio Holzteller"
      ...
      <div class="container accesories-container">
        <div class="row d-flex align-items-center ">
          <div class="col-md-5 d-flex justify-content-center">
            <img class="w-100" src="imgs/bacio-tasche.png" alt="bacio-taschee"
            title="BACIO Tasche">
          </div>
          <div class="col-md-7">
            ...
            <div class="wrap d-flex "><a class="btn-secondary" href="">cool! ich will sie!</a></div>
          </div>
        </div>
      </div>
    </section>
